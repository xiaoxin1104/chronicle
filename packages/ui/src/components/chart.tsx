...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        'border-border/50 bg-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-[var(--shadow-card-lg)]',
        className,
      )}
    >
                  ...
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        ...
                        data-design-audit-allow="chart-payload-color"
                        style={
                          {
